...
# ===============================================================
# Binding energy lookup table (eV)
# Add more if needed
# ===============================================================
BINDING_ENERGIES = {
    "Ne": 21.564,
...
# ===============================================================
# Compute photon energy from wavelength (nm)
# ===============================================================
...
# ===============================================================
# Main fitting function using SciPy
# ===============================================================
def fit_from_inputs(
    wavelength_nm,
    gas,
    ...
    # Calculate standard deviations of parameters if desired
...
# ===============================================================
# Example usage — edit only these lines
# ===============================================================
if __name__ == "__main__":
    wavelength_nm = 815                          # <--- your wavelength
    gas = "Ar"                                   # <--- target gas
    harmonic_orders = [13, 15, 17, 19, 21, 23, 25]       # <--- integers n
    tof_values_1622 = np.array([5.5, 4.62, 3.59, 3.05, 2.72, 2.47, 2.28, 2.13])  # <--- TOF points
